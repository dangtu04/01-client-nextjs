...
export const handleUpdateProductAction = async (id: string,formData: FormData) => {
  const session = await auth();  
  const res = await sendRequestFile<IBackendRes<any>>({
...
export const handleUpdateProductVariantsAction = async (id: any, variants: IProductVariant) => {
